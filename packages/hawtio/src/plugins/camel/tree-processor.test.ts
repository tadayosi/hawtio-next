...
describe('tree-processor', () => {
  ...
  test('processor', async () => {
    ...
    expect(contextsNode.id).toBe('org.apache.camel-camel-contexts-folder')
    ...
    expect(contextNode.id).toBe('org.apache.camel-camel-contexts-SampleCamel-folder')
    ...
    for (const type of types) {
      ...
      expect(node.id).toEqual(`org.apache.camel-camel-contexts-SampleCamel-${type}-folder`)
