import { userService } from '@hawtio/react/auth'
import { eventService } from '@hawtio/react/core'
import { getCookie } from '@hawtio/react/util/cookies'
import {
  escapeMBeanPath,
  onBulkSuccess,
  onListSuccess,
  ...
  onSuccess,
} from '@hawtio/react/util/jolokia'
import { isObject } from '@hawtio/react/util/objects'
import { parseBoolean } from '@hawtio/react/util/strings'
import Jolokia, {
  IAjaxErrorFn,
  IErrorResponse,
  IJmxDomain,
