import { MBeanNode, MBeanTree, TreeProcessor } from '__root__/shared'
import { operationToString } from '@hawtio/react/util/jolokia'
import { isArray } from '@hawtio/react/util/objects'
import { isString } from '@hawtio/react/util/strings'
